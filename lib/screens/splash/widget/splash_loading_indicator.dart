...
class SplashLoadingIndicator extends StatelessWidget {
  const SplashLoadingIndicator({super.key, required this.animation});
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return CustomPaint(
          ...
          painter: _SplashLoadingPainter(progress: animation.value),
        );
      },
    );
  }
...
class _SplashLoadingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final outerRadius = size.shortestSide * 0.38;
    ...
    final outerTipAngle = -math.pi * 1.02 + math.pi * 1.42;
    canvas.drawCircle(
      Offset(
